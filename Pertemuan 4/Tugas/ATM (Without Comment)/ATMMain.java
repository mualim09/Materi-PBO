...
public class ATMMain
{
    ...
    {
        ATM theATM = new ATM(42, "Universitas Gunadarma", "Bank Universiitas Gunadarma",
        ...
        Frame mainFrame = new Frame("Simulasi ATM");
        ...
        MenuItem quitItem = new MenuItem("Keluar", new MenuShortcut('Q'));
